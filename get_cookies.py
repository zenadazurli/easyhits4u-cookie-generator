#!/usr/bin/env python3
# get_cookies.py - Genera cookie e li salva su Supabase (versione per Render)
...
# ==================== CONFIG ====================
SUPABASE_URL = os.environ.get("https://ofijopixtpwahgbwyutc.supabase.co")
SUPABASE_SERVICE_KEY = os.environ.get("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9maWpvcGl4dHB3YWhnYnd5dXRjIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3NTkyODIxMiwiZXhwIjoyMDkxNTA0MjEyfQ.BkWb8EuUUJSUUgg3sepDmOdUzsXY7pjGjykQnPMK9q4")
ACCOUNT_NAME = os.environ.get("ACCOUNT_NAME", "main")  # nome dell'account

EASYHITS_EMAIL = os.environ["EASYHITS_EMAIL"]
EASYHITS_PASSWORD = os.environ["EASYHITS_PASSWORD"]
REFERER_URL = "https://www.easyhits4u.com/?ref=nicolacaporale"
BROWSERLESS_URL = "https://production-sfo.browserless.io/chrome/bql"

# ==================== CHIAVI VALIDE ====================
# Inserisci QUI tutte le tue 343 chiavi (quelle con ✅ VALIDA)
VALID_KEYS = [
